...
var _ = Describe("Reading Weights Using internal method observeWeight", func() {
	...
	BeforeEach(func() {
		namespace = "default"
		k8sClient.DeleteAllOf(ctx(), &v2alpha3.Experiment{}, client.InNamespace(namespace))
	})
	Context("When try to read field from object", func() {
		...
		JustBeforeEach(func() {
			experiment = v2alpha3.NewExperiment(name, namespace).
				WithTarget("target").
				WithTestingPattern(v2alpha3.TestingPatternCanary).
				WithDuration(10, 5, 3).
				Build()
			objRef = &corev1.ObjectReference{
				APIVersion: "iter8.tools/v2alpha3",
				Kind:       "Experiment",
				Name:       name,
				Namespace:  namespace,
			}
		...
		It("A FieldPath into an array returns a valid value", func() {
			...
			exp.Status.CurrentWeightDistribution = []v2alpha3.WeightData{
				{Name: "v1", Value: 10},
				{Name: "v2", Value: 20},
				{Name: "v3", Value: 30},
				{Name: "v4", Value: 40},
...
var _ = Describe("Updating weights from reconcile", func() {
	...
	Context("When create an experiment where all versions have a weightRefObj", func() {
		...
		It("should read all the weights", func() {
			...
			Expect(k8sClient.Create(ctx(), experiment)).Should(Succeed())
			Eventually(func() bool {
				return hasValue(name, namespace, func(exp *v2alpha3.Experiment) bool {
...
var _ = Describe("patch", func() {
	...
	Context("path gets updated", func() {
		...
		var objRef *corev1.ObjectReference
		JustBeforeEach(func() {
			bldr = v2alpha3.NewExperiment(name, namespace).
				WithTarget("target").
				WithTestingPattern(v2alpha3.TestingPatternCanary).
				WithDuration(10, 5, 3)
		...
		It("Should patch the desired field", func() {
			...
			exp.Status.Analysis = &v2alpha3.Analysis{
...
var _ = Describe("Weight Patching", func() {
	...
	Context("When experimentType is Conformance", func() {
		experiment := v2alpha3.NewExperiment("noVersionInfo", namespace).
			WithTarget("target").
	...
	Context("When WeightObjRef is not set", func() {
		experiment := v2alpha3.NewExperiment("noWeightObRef", namespace).
			WithTarget("target").
			WithTestingPattern(v2alpha3.TestingPatternCanary).
			WithDuration(10, 0, 1).
	...
	Context("When WeightObjRef set but no FieldPath", func() {
		experiment := v2alpha3.NewExperiment("noFieldPath", namespace).
			WithTarget("target").
			WithTestingPattern(v2alpha3.TestingPatternCanary).
			WithDuration(10, 0, 1).
	...
	Context("When full WeightObjRef set but no weight recommendation", func() {
		experiment := v2alpha3.NewExperiment("noWeightRecommendation", namespace).
			WithTarget("target").
			WithTestingPattern(v2alpha3.TestingPatternCanary).
			WithDuration(10, 0, 1).
			WithBaselineVersion("baseline", &corev1.ObjectReference{
	...
	Context("When full WeightObjRef and weight recommendation matches current value", func() {
		experiment := v2alpha3.NewExperiment("recommendationIsCurrent", namespace).
			WithTarget("target").
			WithTestingPattern(v2alpha3.TestingPatternCanary).
			WithDuration(10, 0, 1).
			WithBaselineVersion("baseline", &corev1.ObjectReference{
	...
	Context("When full WeightObjRef and weight recommendation does not match the current value", func() {
		experiment := v2alpha3.NewExperiment("recommendationNotCurrent", namespace).
			WithTarget("target").
			WithTestingPattern(v2alpha3.TestingPatternCanary).
			WithDuration(10, 0, 1).
			WithBaselineVersion("baseline", &corev1.ObjectReference{
