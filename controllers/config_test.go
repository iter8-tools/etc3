...
func TestNoInterpolation(t *testing.T) {
	...
	os.Setenv("ITER8_TASKRUNNER", "taskrunner")
	...
	if cfg.TaskRunner != "taskrunner" {
		t.Errorf("cfg.TaskRunner incorrect. Expected: %s, got: %s", "taskrunner", cfg.TaskRunner)
	}
...
func TestInterpolation(t *testing.T) {
	...
	os.Setenv("TASKRUNNER", "taskrunner")
