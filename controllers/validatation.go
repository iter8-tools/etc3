...
func (r *ExperimentReconciler) IsExperimentValid(ctx context.Context, instance *v2alpha3.Experiment) bool {
	return true
}
...
func (r *ExperimentReconciler) IsVersionInfoValid(ctx context.Context, instance *v2alpha3.Experiment) bool {
	// Verify that versionInfo is present
	if instance.Spec.VersionInfo == nil {
		r.recordExperimentFailed(ctx, instance, v2alpha3.ReasonInvalidExperiment, "No versionInfo in experiment")
		return false
	}
	...
	if !candidatesMatchStrategy(instance.Spec) {
		r.recordExperimentFailed(ctx, instance, v2alpha3.ReasonInvalidExperiment, "Invalid number of candidates for %s experiment", instance.Spec.Strategy.TestingPattern)
		return false
	}
	// Verify that the names of the versionns are all unique
	if !versionsUnique(instance.Spec) {
		r.recordExperimentFailed(ctx, instance, v2alpha3.ReasonInvalidExperiment, "Version names are not unique")
		return false
	}
	...
	if !validNumberOfRewards(instance.Spec) {
		r.recordExperimentFailed(ctx, instance, v2alpha3.ReasonInvalidExperiment, "Invalid number of rewards for %s experiment", instance.Spec.Strategy.TestingPattern)
		return false
	}
	...
	if b != nil && b.FieldPath != "" && b.FieldPath[0] != '.' {
		r.recordExperimentFailed(ctx, instance, v2alpha3.ReasonInvalidExperiment, "Fieldpaths must start with '.'")
		return false
	}
...
func candidatesMatchStrategy(s v2alpha3.ExperimentSpec) bool {
	switch s.Strategy.TestingPattern {
	case v2alpha3.TestingPatternConformance:
		return len(s.VersionInfo.Candidates) == 0
	case v2alpha3.TestingPatternAB, v2alpha3.TestingPatternCanary:
		return len(s.VersionInfo.Candidates) == 1
	case v2alpha3.TestingPatternABN:
		return len(s.VersionInfo.Candidates) > 0
	}
	return true
}

func versionsUnique(s v2alpha3.ExperimentSpec) bool {
...
func validNumberOfRewards(s v2alpha3.ExperimentSpec) bool {
	switch s.Strategy.TestingPattern {
	case v2alpha3.TestingPatternConformance:
		return s.Criteria == nil || len(s.Criteria.Rewards) == 0
	case v2alpha3.TestingPatternCanary:
		return s.Criteria == nil || len(s.Criteria.Rewards) == 0
	case v2alpha3.TestingPatternAB:
