...
func (in *VersionAssessmentAnalysis) DeepCopyInto(out *VersionAssessmentAnalysis) {
	*out = *in
	...
	if in.Data != nil {
		in, out := &in.Data, &out.Data
		*out = make([]VersionAssessmentData, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionAssessmentData) DeepCopyInto(out *VersionAssessmentData) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionAssessmentData.
func (in *VersionAssessmentData) DeepCopy() *VersionAssessmentData {
	if in == nil {
		return nil
	}
	out := new(VersionAssessmentData)
	in.DeepCopyInto(out)
	return out
}
