...
func (in *Analysis) DeepCopyInto(out *Analysis) {
	*out = *in
	if in.BuiltinHists != nil {
		in, out := &in.BuiltinHists, &out.BuiltinHists
		*out = new(apiextensionsv1.JSON)
		(*in).DeepCopyInto(*out)
	}
	if in.Metrics != nil {
		in, out := &in.Metrics, &out.Metrics
		*out = new(map[string]MetricsData)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]MetricsData, len(*in))
			for key, val := range *in {
...
func (in *MetricsData) DeepCopyInto(out *MetricsData) {
	*out = *in
	...
	if in.Data != nil {
		...
		*out = make(map[string]MetricsVersionData, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricsVersionData) DeepCopyInto(out *MetricsVersionData) {
	*out = *in
	if in.Max != nil {
		in, out := &in.Max, &out.Max
		x := (*in).DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricsVersionData.
func (in *MetricsVersionData) DeepCopy() *MetricsVersionData {
	if in == nil {
		return nil
	}
	out := new(MetricsVersionData)
	in.DeepCopyInto(out)
	return out
}
